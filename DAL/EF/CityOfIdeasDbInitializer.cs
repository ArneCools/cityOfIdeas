    ...
    internal static class CityOfIdeasDbInitializer
    {
        ...
        private static void Seed(CityOfIdeasDbContext ctx)
        {
            ...
            var m1 = new Media()
            {
                ...
                Url =  "https://storage.googleapis.com/ui-gen/platform-logos/1559949616805_Havenbedrijf"
            };
            ...
            Phase ph14 = new Phase()
            {
                Description = "afwerkfase",
                Number = 3,
                Title = "afwerkfase"
            };
...
//            ctx.Add(platformClaim3);
            ...
            {
                CentralQuestion = "Wil je dat de kaaien er binnenkort zo uitzien?",
            ...
            {
                QuestionString = "Is de staat van de kaaien nu goed?",
                Options = new List<string> { "Ja", "Neen", "Geen mening" },
                FieldType = FieldType.SingleChoice,
                Required = true,
                OrderIndex = 4
            ...
            Answer r3A4 = new MediaAnswer()
            {
                ...
                {
                    Url =
                        "https://images1.persgroep.net/rcs/-NPQOEgq90rpqmmyN19-08lYAtE/diocontent/103809201/_crop/0/0/2160/1080/_fitwidth/763?appId=2dc96dd3f167e919913d808324cbfeb2&quality=0.8",                   
