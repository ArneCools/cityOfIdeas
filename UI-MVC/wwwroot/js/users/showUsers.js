...
async function submitUsernameAndClaim(val) {
    ...
    try {
        ...
        toastr.clear();
        toastr.error('Er ging iets mis bij het wijzigen van de claim, sorry.')
    }
}
...
async function deleteUserTrue(val) {
    ...
    try {
        ...
        toastr.clear();
        toastr.error('Er ging iets mis bij het verwijderen van gebruiker ' + data.text + ', sorry.');
        console.error(err);
    }
}
...
async function blockUser(val, duration) {
    ...
    try {
        ...
        toastr.clear();
        toastr.error('Er ging iets mis bij het blokkeren van de gebruiker, sorry.');
        console.error(err);
    }
}
...
async function getUsers() {
    try {
        ...
        toastr.error('Er ging iets mis bij het inladen van de gebruikers, sorry.');
        return [];
    }
}
