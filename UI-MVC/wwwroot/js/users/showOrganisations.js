...
async function deleteUserTrue(val) {
    ...
    try {
        ...
        toastr.clear();
        toastr.error('Er ging iets mis bij het verwijderen van organisatie'+data.text+', sorry.');
        console.error(err);
    }
}
...
async function blockUser(val, duration) {
    ...
    try {
        ...
        toastr.clear();
        toastr.error('Er ging iets mis bij het blokkeren van de organisatie, sorry.');
        console.error(err);
    }
}
...
async function getUsers() {
    try {
        ...
        toastr.error('Er ging iets mis bij het inladen van de organisaties, sorry.');
        // alert(err);
        return [];
    }
}
